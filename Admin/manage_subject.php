        ...
        <div id="editSubjectModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea id="edit_subject_name" name="subject_name" required></textarea>

                    <label for="edit_subject_code">Subject Code:</label>
                    <textarea id="edit_subject_code" name="subject_code" required></textarea>
        ...
        <div class="table-container">
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<button class='btn btn-remove' onclick='showRemoveConfirmation(" . htmlspecialchars($row["subID"]) . ")'>Remove</button>";
                    echo "</td>";
                    echo "</tr>";
                }
                echo "</table>";
